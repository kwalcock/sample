...
name := "sample"
description := "The sample project implements the org.clulab.sample package including the Sample class."
...
lazy val core = (project in file("."))
  ...
  .settings(
    assembly / mainClass := Some("org.clulab.sample.apps.HelloWorldApp")
  )
